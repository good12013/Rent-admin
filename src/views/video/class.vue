<template>
  <div class="app-container">
    <div class="btn-box">
        <el-button type="success" @click.stop="handleAddClass">新建分类</el-button>
    </div>
    ...
    <el-table :data="dataList" style="width: 100%;margin-top:30px;" border>
      ...
      <el-table-column align="center" label="分类描述" prop="desc"></el-table-column>
    ...
    <el-dialog :title="dialogType==='edit'?'编辑分类':'新建分类'" :visible.sync="dialogVisible">
    ...
    async confirmClass() {
      ...
      if (isEdit) {
        ...
        await this.ObjRequired(this.data,'desc',() => {
         ...
         const params = { desc : this.data.desc , name : this.data.name , section : "short" }
         this.POST(
          "/api/v1.0/categories",
          params,
          data=>{
