  ...
  methods: {
    ...
    loadData(pagination, filters, sorter) {
      ...
      const parameter = Object.assign(
        {
          pagination: {
            page: (pagination && pagination.current) || this.localPagination.current,
            per_page: (pagination && pagination.pageSize) || this.localPagination.pageSize
          }
        },
        {
          sort:
      ...
      if ((typeof result === 'object' || typeof result === 'function') && typeof result.then === 'function') {
        result.then(r => {
          ...
          // if (r.Shops.length === 0 && this.localPagination.current > 1) {
